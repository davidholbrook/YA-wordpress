...
if ( ! function_exists( 'yeah_academy_setup' ) ) :
	...
	function yeah_academy_setup() {
		...
		add_theme_support( 'custom-background', apply_filters( 'yeah_academy_custom_background_args', array(
 ...
 */
function yeah_academy_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'yeah_academy_content_width', 640 );
}
add_action( 'after_setup_theme', 'yeah_academy_content_width', 0 );
 ...
 */
function yeah_academy_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'yeah-academy' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'yeah-academy' ),
...
add_action( 'widgets_init', 'yeah_academy_widgets_init' );
